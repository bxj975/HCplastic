...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window portal-login-page" component="$UI/system/components/justep/window/window"
  sysParam="false" style="background-repeat:no-repeat;background-image: url(images/custom2.jpg);background-position:bottom;">  
  ...
  <div class="page-login" xid="pageLogin" style="margin-top:0; padding-top: 18px;"> 
    <div class="page-header" style="text-align: center;font-size: 24px; margin-top:0; padding-top: 24px;"
      xid="pageHeader"> 
      <div class="form-container" align="center">济南合成塑料订单及客户管理系统</div> 
    </div>  
