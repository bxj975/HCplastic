...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xu="http://www.xmldb.org/xupdate"
  xmlns:xui="http://www.justep.com/xui" __id="id_1" extends="$UI/portal/base/base.w" xid="window" class="window body page-quick-sidebar-over-content page-sidebar-closed-hide-logo page-header-fixed page-sidebar-fixed page-footer-fixed"
  ...
  <div class="page-root" style="display: none;" xui:parent="window" xui:update-mode="insert"> 
    ...
    <div class="page-header navbar navbar-fixed-top" style="height:46px;"> 
      ...
      <div class="page-header-inner"> 
        ...
        <div> 
          <h3 style="float:left; color:white; margin-top:13px;">12121212121系统标题</h3> 
        </div>  
        <div class="top-menu"> 
          <ul class="nav navbar-nav pull-right"> 
            ...
            <li id="portal-agent" class="dropdown dropdown-user x-portal-agent"
              style="display:none;"> 
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                data-x5-hover="dropdown" data-close-others="true"> 
                <i class="icon-ios7-browsers"/>  
            ...
            <li class="dropdown dropdown-user"> 
              <a class="dropdown-toggle x-portal-task-wait"> 
                <span class="username username-hide-on-mobile">待办任务
                  <span class="badge" bind-text="waitTaskCount"/>
                </span> 
              </a> 
            </li>  
            <li class="dropdown dropdown-user"> 
              <a id="portal-reload" class="dropdown-toggle x-portal-reload"
                style="display:none;"> 
            ...
            <li class="dropdown dropdown-user"> 
              ...
              <ul class="dropdown-menu dropdown-menu-default"> 
                ...
                <li> 
                  <a component="$UI/system/components/justep/button/button"
                    class="x-portal-setPassWord" icon="icon-ios7-gear-outline" label="修改密码"
                    href="#" xid="changPasswordBtn"> 
                    <i class="icon-ios7-gear-outline"/> 修改密码
                  </a> 
                </li>  
                <li class="divider user-divider"/>  
                <li> 
                  <a component="$UI/system/components/justep/button/button"
                    class="x-portal-logout" label="注销" xid="logoutBtn" icon="icon-power"> 
        ...
        <div class="page-sidebar navbar-collapse collapse"> 
          ...
          <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true"
            ...
            <li class="start active open"> 
              <a class="ajaxify x-portal-showMain"> 
                <i class="icon-home"/>  
    ...
    <div class="page-footer" style="height: 33px;"> 
      <div class="page-footer-inner">2000-2016 © 济南井然信息技术有限公司4000-676-018</div>  
  ...
  <div xui:parent="window" xui:update-mode="insert"> 
    <span component="$UI/system/components/justep/windowDialog/windowDialog"
      xid="configDialog" src="$UI/portal/pc/config/theme.w" status="normal" width="420px"
      height="auto" top="100px" style="left:36px;top:60px;"/> 
  </div> 
</div>
