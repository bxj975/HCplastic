...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xu="http://www.xmldb.org/xupdate"
  ...
  <div class="wrapper" style="display:none;" xui:parent="window" xui:update-mode="insert"> 
    <header class="main-header"> 
      ...
      <nav class="navbar navbar-static-top"> 
        ...
        <div> 
          <h3 style="float:left; color:white; margin-top:13px;">济南合成塑料订单及客户管理系统</h3> 
        </div>  
          ...
          <ul class="nav navbar-nav"> 
            ...
            <li class="dropdown"> 
              <a class="dropdown-toggle" title="系统时间"> 
                <i class="fa fa-clock-o x-datetime-icon"/>  
                <span class="hidden-xs x-portal-datetime"/> 
              </a> 
            </li>  
            ...
            <li class="dropdown user user-menu"> 
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
                ...
                <span class="hidden-xs x-portal-username"/> 
              </a>  
              <ul class="dropdown-menu"> 
                <!-- User image -->  
                <li class="user-header"> 
                  <img class="img-circle x-person-avatar"/>  
                  <p class="x-person-info"></p> 
                </li>  
                <!-- Menu Body -->  
                <!-- 可以增加其他的功能菜单
              <li class="user-body">
            ...
            <li> 
              <a href="#" data-toggle="control-sidebar" title="设置">
                <i class="fa fa-gears"/>
              </a> 
            </li> 
          </ul> 
      ...
      <section class="sidebar"> 
        ...
        <div class="user-panel"> 
          ...
          <div class="pull-left info"> 
            <p class="x-portal-username"></p>  
            <a>
              <i class="fa fa-circle text-success"/>
              <span class="x-login-datetime"/>
            </a> 
          </div> 
        </div>  
        <!-- search form -->  
        ...
        <ol class="breadcrumb"> 
          <li> 
            <a component="$UI/system/components/justep/button/button" xid="closeFuncBtn"
              class="x-closeFuncBtn" onClick="closeFuncBtnClick"> 
    ...
    <footer class="main-footer"> 
      <strong>Copyright 2016 
        <a href="http://xkaifa.com" target="_blank">TEL:15553101899</a>.
    ...
    <aside class="control-sidebar control-sidebar-dark"> 
      ...
      <ul class="nav nav-tabs nav-justified control-sidebar-tabs"> 
        <li class="active">
          <a href="#control-sidebar-func-tab" data-toggle="tab">
            <i class="x-tabs-icon fa fa-clone"/>已开功能
          </a>
        </li> 
      </ul>  
      <!-- Tab panes -->  
      <div class="tab-content"> 
        ...
        <div class="tab-pane functionOpened active" id="control-sidebar-func-tab"> 
          <h3 class="control-sidebar-heading">已打开
            <span class="functionOpenedCount">0</span>个功能
            <a href="#" class="closeAll">全部关闭</a>
          </h3>  
          <ul class="control-sidebar-menu functionOpenedList"></ul>  
