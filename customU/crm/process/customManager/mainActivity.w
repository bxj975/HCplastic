...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:179px;left:633px;"
    ...
    <div component="$UI/system/components/justep/data/bizData" autoLoad="true" xid="personData" concept="CU_ZYXX">
   <creator xid="default15" action="/custom/crm/logic/action/createCU_ZYXXAction"></creator>
   <reader xid="default16" action="/custom/crm/logic/action/queryCU_ZYXXAction"></reader>
   <writer xid="default17" action="/custom/crm/logic/action/saveCU_ZYXXAction"></writer></div><div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="lxData" idColumn="type"> 
      <column label="type" name="type" type="String" xid="xid4"/>  
      <data xid="default4">[{&quot;type&quot;:&quot;是&quot;},{&quot;type&quot;:&quot;否&quot;}]</data></div>  
    <div component="$UI/system/components/justep/data/bizData" autoLoad="true" xid="typeData" concept="CU_KHFL" directDelete="false" updateMode="whereAll">
   <creator xid="default61" action="/custom/crm/logic/action/createCU_KHFLAction"></creator>
   <reader xid="default71" action="/custom/crm/logic/action/queryCU_KHFLAction"></reader>
   <writer xid="default81" action="/custom/crm/logic/action/saveCU_KHFLAction"></writer></div><div component="$UI/system/components/justep/data/data" autoLoad="true"
            ...
            <div xid="mainForm" class="form-horizontal" component="$UI/system/components/bootstrap/form/form"
              ...
              <div xid="formGroup4" class="form-group"> 
                ...
                <div xid="col42" class="col-sm-10"> 
                  <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="typeGridSelect" bind-ref='$model.mainData.ref("fKHLB")'>
   <option xid="option7" data="typeData" value="CU_KHFL" label="fFLMC"></option></div></div> 
              </div>  
              <div xid="formGroup5" class="form-group"> 
                ...
                <div xid="col52" class="col-sm-10"> 
                  <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="areaGridSelect" bind-ref='$model.mainData.ref("fSZQY")'>
   <option xid="option6" data="areaData" value="CU_QYXX" label="fFLMC"></option></div></div> 
              </div>  
              ...
              <div xid="formGroup12" class="form-group"> 
                ...
                <div xid="col122" class="col-sm-10"> 
                  <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="jsGridSelect" bind-ref='$model.mainData.ref("fJSFS")'>
   <option xid="option5" data="jsData" value="type" label="type"></option></div></div> 
              </div>  
              <div xid="formGroup14" class="form-group"> 
                ...
                <div xid="col142" class="col-sm-10"> 
                  <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="personGridSelect" bind-ref='$model.mainData.ref("fGZR")'>
   <option xid="option4" data="personData" value="CU_ZYXX" label="fZYMC"></option>
  <div component="$UI/system/components/justep/data/bizData" autoLoad="false" xid="personData" concept="CU_ZYXX" limit="60">
   <reader xid="default5" action="/custom/crm/logic/action/queryCU_ZYXXAction"></reader>
   <filter name="filter0" xid="filter1"></filter>
   <creator xid="default10" action="/custom/crm/logic/action/createCU_ZYXXAction"></creator>
   <writer xid="default11" action="/custom/crm/logic/action/saveCU_ZYXXAction"></writer></div></div></div> 
              </div>  
              <div xid="formGroup15" class="form-group"> 
                <div xid="col151" class="col-sm-2"> 
                  <label xid="fLXKHL" class="control-label" bind-text="mainData.label('fLXKH')"/>
                </div>  
                <div xid="col152" class="col-sm-10"> 
                  <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="lxGridSelect" bind-ref='$model.mainData.ref("fLXKH")'>
   <option xid="option3" data="lxData" value="type" label="type"></option></div></div> 
              </div>  
              ...
              <div xid="formGroup16" class="form-group"> 
                ...
                <div xid="col162" class="col-sm-10"> 
                 <textarea xid="fZDYY" class="form-control" component="$UI/system/components/justep/textarea/textarea"
                    bind-ref="mainData.ref('fZDYY')" style="height:120px;"/>
                </div> 
              </div>  
              <div xid="formGroup17" class="form-group"> 
                ...
                <textarea xid="fZDYE" class="form-control" component="$UI/system/components/justep/textarea/textarea"
                    bind-ref="mainData.ref('fZDYE')" style="height:120px;"/>
                </div> 
              </div>  
              <div xid="formGroup18" class="form-group"> 
                ...
                <textarea xid="fZDYS" class="form-control" component="$UI/system/components/justep/textarea/textarea"
                    bind-ref="mainData.ref('fZDYS')" style="height:120px;"/>
                </div> 
              </div>  
              <div xid="formGroup19" class="form-group"> 
                ...
                <textarea xid="fZDYSI" class="form-control" component="$UI/system/components/justep/textarea/textarea"
                    bind-ref="mainData.ref('fZDYSI')" style="height:120px;"/> 
                </div> 
              </div>  
              <div xid="formGroup20" class="form-group"> 
                ...
                <textarea xid="fZDYW" class="form-control" component="$UI/system/components/justep/textarea/textarea"
                    bind-ref="mainData.ref('fZDYW')" style="height:120px;"/>
                </div> 
              </div>  
              <div xid="formGroup21" class="form-group"> 
                ...
                <textarea xid="fZDYL" class="form-control" component="$UI/system/components/justep/textarea/textarea"
                    bind-ref="mainData.ref('fZDYL')" style="height:120px;"/> 
                </div> 
              </div>  
