...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:350px;top:185px;" onLoad="modelLoad">
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="CU_YWLX" limit="15" columns=""
      onSaveCommit="saveCommit" onValueChanged="mainDataValueChanged"> 
      <reader action="/custom/crm/logic/action/queryCU_YWLXAction"/>  
      <writer action="/custom/crm/logic/action/saveCU_YWLXAction"/>  
      <creator action="/custom/crm/logic/action/createCU_YWLXAction"/>  
  ...
  <data xid="default5">[{&quot;type&quot;:&quot;一类&quot;},{&quot;type&quot;:&quot;二类&quot;}]</data></div></div>  
      ...
      <div class="tab-pane active" xid="list"> 
        <div xid="bar" component="$UI/system/components/justep/toolBar/toolBar"
          ...
          <div component="$UI/system/components/justep/smartFilter/smartFilter"
            xid="smartFilter1" filterData="mainData" class="pull-right" filterCols="fXXBM,fYWMC,fBZ,fWHSJ,fWHR"> 
        ...
        <div component="$UI/system/components/justep/dataTables/dataTables"
          ...
          data="mainData" rowActiveClass="active" onRowDblClick="grid3RowClick" responsive="true"> 
          <columns xid="column">
            <column name="fXXBM"/> 
            <column name="fYWMC"/> 
            <column name="fLB"/> 
            ...
            <div xid="mainForm" class="form-horizontal" component="$UI/system/components/bootstrap/form/form"
              ...
              <div xid="formGroup3" class="form-group"> 
                <div xid="col31" class="col-sm-2"> 
                  <label xid="fYWMCL" class="control-label" bind-text="mainData.label('fYWMC')"/> 
                </div>  
                <div xid="col32" class="col-sm-10">
                  <input xid="fYWMC" class="form-control" component="$UI/system/components/justep/input/input"
                    bind-ref="mainData.ref('fYWMC')"/>
                </div> 
              </div> 
               <div xid="formGroup14" class="form-group"> 
                ...
                <div xid="col42" class="col-sm-10">
                  <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect1" bind-ref='$model.mainData.ref("fLB")'>
   <option xid="option1" data="typeData" value="type" label="type"></option></div></div> 
              </div> 
