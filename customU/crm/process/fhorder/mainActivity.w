...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    style="top:47px;left:624px;height:auto;"> 
    <div component="$UI/system/components/justep/reportData/reportData" xid="p1"> 
      <source xid="default1"> 
        <action xid="default2" name="fhorderAction" type="ksqlaction"/> 
      </source> 
    </div>  
  ...
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar form-inline x-toolbar-spliter"
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-link"
      label="确认" xid="yesBtn" icon="linear linear-bubble" onClick="yesBtnClick" disabled="true"> 
      <i xid="i7" class="linear linear-bubble"/>  
    ...
    <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox"
      xid="printCheckbox" checked="false" checkedValue="1" uncheckedValue="0" label="已打印"/>
  ...
  <div component="$UI/system/components/justep/report/report" src="fhorder_xls.xml"
